      ...
      <div className="mx-auto max-w-screen-xl border-t border-gray-200 pt-6 dark:border-white/[0.08]">
        <div className="flex flex-col justify-between gap-5 sm:flex-row sm:items-center">
          ...
          <div className="flex flex-wrap items-center gap-4 text-[13px] text-gray-600 dark:text-gray-400">
            <a
              href="#"
              className="inline-flex items-center gap-2 transition-colors hover:text-(--color-primary)"
            >
            ...
            <span className="hidden h-4 w-px bg-gray-200 dark:bg-white/[0.08] sm:block" />
            <a
              href="#"
